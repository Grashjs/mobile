const trJSON = {
  ...
  'wo_age_description': 'İş emri yaşı, iş emrinin (veya iş talebinin) oluşturulması ile bugün arasında geçen gün sayısı olarak tanımlanır.',
  ...
  'no_notification_message': 'Çalışmanızın ilerleyişini takip etmenize yardımcı olmak için önemli güncellemeler burada görünecek',
  ...
  'confirm_delete_file_location': 'Bu dosyayı bu konumdan kaldırmak istediğinizden emin misiniz?',
  'confirm_delete_file_part': 'Bu dosyayı bu bölümden kaldırmak istediğinizden emin misiniz?',
  ...
  'report': 'Rapor',
  'end_cannot_be_ulterior_to_start': 'Bitiş tarihi başlangıç ​​tarihinden sonra olamaz',
  'storage_permission_needed_description': 'Dosyayı indirmek için depolama izni vermeniz gerekiyor',
  ...
  'no_notification_permission_description': 'Lütfen ayarlara gidin ve bildirim iznini manuel olarak etkinleştirin',
  'allow': 'İzin vermek',
